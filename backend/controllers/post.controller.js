...
export const createPost = async (req, res) => {
    try {
        ...
        console.log("Erorr in create Post controller", error)
    }
}
...
export const commentOnPost = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: "Internal server error" });
        console.log("Eror in commentOnPost controller ", error)
    }
}
...
export const likeUnlikePost = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: "Internal server error" })
        console.log("Erorr in Like and Unlike Post controller", error.message)
    }
}
